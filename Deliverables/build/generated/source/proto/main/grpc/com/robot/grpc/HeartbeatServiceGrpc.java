...
public final class HeartbeatServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.robot.grpc.HeartbeatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.robot.grpc.RobotService.HeartbeatRequest,
      com.robot.grpc.RobotService.HeartbeatResponse> getSendHeartbeatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendHeartbeat",
      requestType = com.robot.grpc.RobotService.HeartbeatRequest.class,
      responseType = com.robot.grpc.RobotService.HeartbeatResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.robot.grpc.RobotService.HeartbeatRequest,
      com.robot.grpc.RobotService.HeartbeatResponse> getSendHeartbeatMethod() {
    io.grpc.MethodDescriptor<com.robot.grpc.RobotService.HeartbeatRequest, com.robot.grpc.RobotService.HeartbeatResponse> getSendHeartbeatMethod;
    if ((getSendHeartbeatMethod = HeartbeatServiceGrpc.getSendHeartbeatMethod) == null) {
      synchronized (HeartbeatServiceGrpc.class) {
        if ((getSendHeartbeatMethod = HeartbeatServiceGrpc.getSendHeartbeatMethod) == null) {
          HeartbeatServiceGrpc.getSendHeartbeatMethod = getSendHeartbeatMethod =
              io.grpc.MethodDescriptor.<com.robot.grpc.RobotService.HeartbeatRequest, com.robot.grpc.RobotService.HeartbeatResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendHeartbeat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.robot.grpc.RobotService.HeartbeatRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.robot.grpc.RobotService.HeartbeatResponse.getDefaultInstance()))
              .setSchemaDescriptor(new HeartbeatServiceMethodDescriptorSupplier("SendHeartbeat"))
              .build();
        }
      }
    }
  ...
  public static abstract class HeartbeatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendHeartbeat(com.robot.grpc.RobotService.HeartbeatRequest request,
        io.grpc.stub.StreamObserver<com.robot.grpc.RobotService.HeartbeatResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.robot.grpc.RobotService.HeartbeatRequest,
  ...
  public static final class HeartbeatServiceBlockingStub extends io.grpc.stub.AbstractStub<HeartbeatServiceBlockingStub> {
    ...
    /**
     */
    public com.robot.grpc.RobotService.HeartbeatResponse sendHeartbeat(com.robot.grpc.RobotService.HeartbeatRequest request) {
  ...
  public static final class HeartbeatServiceFutureStub extends io.grpc.stub.AbstractStub<HeartbeatServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.robot.grpc.RobotService.HeartbeatResponse> sendHeartbeat(
        com.robot.grpc.RobotService.HeartbeatRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_HEARTBEAT:
          serviceImpl.sendHeartbeat((com.robot.grpc.RobotService.HeartbeatRequest) request,
              (io.grpc.stub.StreamObserver<com.robot.grpc.RobotService.HeartbeatResponse>) responseObserver);
          break;
        default:
