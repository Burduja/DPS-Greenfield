...
public final class GreetServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.robot.grpc.GreetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.robot.grpc.RobotService.GreetingRequest,
      com.robot.grpc.RobotService.GreetingResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Greet",
      requestType = com.robot.grpc.RobotService.GreetingRequest.class,
      responseType = com.robot.grpc.RobotService.GreetingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.robot.grpc.RobotService.GreetingRequest,
      com.robot.grpc.RobotService.GreetingResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<com.robot.grpc.RobotService.GreetingRequest, com.robot.grpc.RobotService.GreetingResponse> getGreetMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetMethod = GreetServiceGrpc.getGreetMethod) == null) {
          GreetServiceGrpc.getGreetMethod = getGreetMethod =
              io.grpc.MethodDescriptor.<com.robot.grpc.RobotService.GreetingRequest, com.robot.grpc.RobotService.GreetingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.robot.grpc.RobotService.GreetingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.robot.grpc.RobotService.GreetingResponse.getDefaultInstance()))
  ...
  public static abstract class GreetServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greet(com.robot.grpc.RobotService.GreetingRequest request,
        io.grpc.stub.StreamObserver<com.robot.grpc.RobotService.GreetingResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.robot.grpc.RobotService.GreetingRequest,
                com.robot.grpc.RobotService.GreetingResponse>(
                  this, METHODID_GREET)))
          .build();
    }
  }
  ...
  public static final class GreetServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetServiceBlockingStub> {
    ...
    /**
     */
    public com.robot.grpc.RobotService.GreetingResponse greet(com.robot.grpc.RobotService.GreetingRequest request) {
  ...
  public static final class GreetServiceFutureStub extends io.grpc.stub.AbstractStub<GreetServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.robot.grpc.RobotService.GreetingResponse> greet(
        com.robot.grpc.RobotService.GreetingRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((com.robot.grpc.RobotService.GreetingRequest) request,
              (io.grpc.stub.StreamObserver<com.robot.grpc.RobotService.GreetingResponse>) responseObserver);
          break;
        default:
